...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (launchButton) {
        launchButton.addEventListener('click', function(e) {
            ...
            this.innerHTML = '<div class="loading-indicator"><div class="loading-dot"></div><div class="loading-dot"></div><div class="loading-dot"></div></div>';
            
            // Simulate loading (in a real app, this would be actual loading)
            setTimeout(() => {
                // Reset button and show a message
                this.innerHTML = originalText;
                alert('VR Tour is launching. Please wait...');
                // Here you would typically load the VR tour
            }, 2000);
        });
    }
